        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-lg font-semibold text-slate-900 tracking-tight">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('plans.index')" :active="request()->routeIs('plans.*') || request()->routeIs('home')">
                        {{ __('Plans') }}
                    </x-nav-link>
